...
def func_update_qacc(
    ...
    for i_d, i_b in ti.ndrange(n_dofs, _B):
        ...
        dofs_state.force[i_f, i_d, i_b] = dofs_state.qf_smooth[i_f, i_d, i_b] + constraint_state.qfrc_constraint[i_d, i_b]
...
def func_update_constraint(
    ...
    # (Mx - Mx') * (x - x')
    for i_d in range(n_dofs):
        v = 0.5 * (Ma[i_d, i_b] - dofs_state.force[i_f, i_d, i_b]) * (qacc[i_d, i_b] - dofs_state.acc_smooth[i_f, i_d, i_b])
